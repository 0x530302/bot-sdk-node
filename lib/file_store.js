...
const debug = require('debug')('wire:bot-api:file_store');
...
module.exports = class FileStore extends cryptobox.CryptoboxStore {
  ...
  save_session(session_id, session) {
    debug(`save_session ${session_id} ${session.serialise()}`);
